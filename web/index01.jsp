...
<html>
    ...
    <body>
        <p>Formulardaten: 
            ...
            Email: <%= request.getParameter("email")%>, Geburtstag: <%= request.getParameter("birthdate")%>, 
            Erfahrung: <%= request.getParameter("experience")%>, Erklärung: <%= request.getParameter("agreed")%>
        </p>
        <header>
